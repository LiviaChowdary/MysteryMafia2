class Game {
    ...
    async start(){
        ...
        player1Vote = createSprite(displayWidth/2-70, displayHeight/4,150,50);
        player2Vote = createSprite(displayWidth/2-70, displayHeight/4+70,150,50);
        player3Vote = createSprite(displayWidth/2-70, displayHeight/4+140,150,50);
      //  player4Vote = createSprite(displayWidth/2-70, displayHeight/4+210,100,50); 
